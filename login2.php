...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">ホーム</a></li>
      ...
      <div class="main">
        <section class="module bg-dark-30" data-background="assets/images/touroku.jpg">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt mb-0">ログイン（新規登録）</h1>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-5 col-sm-offset-1 mb-sm-40">
                <h4 class="font-alt">すでにユーザー登録がお済みの方</h4>
                <hr class="divider-w mb-10">
                <form class="form" action="login-act2.php" method="post">
                  <div class="form-group">
                    <input class="form-control" type="text" name="admin_id" placeholder="Username"/>
                  </div>
                  <div class="form-group">
                    <input class="form-control" type="password" name="admin_pass" placeholder="Password"/>
                  </div>
                  <div class="form-group">
                    <input class="btn btn-round btn-b" type="submit" value="ログイン">  
                </div>
                
                </form>
              </div>
              <div class="col-sm-5">
                <h4 class="font-alt">ユーザー新規登録</h4>
                <hr class="divider-w mb-10">
                <form class="form" method="post" action="user_insert.php">
                 
                  <div class="form-group">
                    <input class="form-control" type="text" name="admin_name" placeholder="お名前"/>
                  </div>
                  <div class="form-group">
                    <input class="form-control" type="text" name="admin_id" placeholder="Email"/>
                  </div>
                  <div class="form-group">
                    <input class="form-control" type="text" name="com_name" placeholder="ニックネーム"/>
                  </div>
                  <div class="form-group">
                    <input class="form-control" type="password" name="admin_pass" placeholder="任意のパスワード"/>
                  </div>
           
                  <div class="form-group">
                    <input class="btn btn-block btn-round btn-b" type="submit" value="送信">
                  </div>
                </form>
              </div>
            </div>
